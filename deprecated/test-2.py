...
if __name__ == "__main__":
    ...
    data_img_size = 224
    data_batch_size = 512   # lascia questo bs
    ...
    mobileNet_v2 = squeezenet1_1(pretrained=True)

    mobileNet_v2.classifier = nn.Identity()

    print("**** required for squeezeNet: {} ****".format( mobileNet_v2(torch.zeros(1,3,data_img_size,data_img_size)).shape))
    ...
    logger = TensorBoardLogger("metric_logs", name="siamese_squezeNet_v1_1")
    ...
    trainer.save_checkpoint('ckpt_backup/triplet_squeezeNet_{}_batch.ckpt'.format(data_batch_size) )
