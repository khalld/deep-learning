...
\begin{algorithm}
\caption{\texttt{Iterated Local Search - A, B}}
\begin{algorithmic}
    \Require {\texttt{list of all nodes of instances}}
    \State {\texttt{InitialSolution = create initial solution from random node}}
    \State {\texttt{CurrentSolution = Apply LocalSearch to InitialSolution}}
    ...
    \While{ \texttt{max evaluations} }   
        ...
        \State{
            \If{
                \texttt{cost of SolutionToChange < cost of CurrentSolution and \\  SolutionToChange not in term-memory}
            }
...
\begin{algorithm}
\caption{\texttt{Iterated Local Search - C, D}}
\begin{algorithmic}
    \Require {\texttt{list of all nodes of instances}}
