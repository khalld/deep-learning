...
\begin{center}
    ...
    \end{minipage}
    \captionof{figure}{Grafico di convergenza di training (sx) e validation (dx) del modello utilizzando Triplet Margin Loss (arancione) e Triplet Margin with Distance Loss (blu)}
\end{center}
